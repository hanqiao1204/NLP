...
class Encoder(nn.Module):
    ...
    def __init__(self, input_size, emb_size, encoder_hidden_size, decoder_hidden_size, dropout=0.2, model_type="RNN"):
        ...
        self.ln_1 = nn.Linear(encoder_hidden_size, encoder_hidden_size)
        self.rlu = nn.ReLU()
        self.ln_2 = nn.Linear(encoder_hidden_size, decoder_hidden_size)
    ...
    def forward(self, input):
        ...
        if self.model_type == "RNN":
            ...
            o_gate, (output, hidden) = self.recurrent(embedded)
        
        
       
        l1 = self.ln_1(hidden)
        l2 = self.ln_2(self.rlu(l1))
        hidden = self.tahn(l2)
